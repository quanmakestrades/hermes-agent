...
import { type AppView, ARTIFACTS_ROUTE, MESSAGING_ROUTE, SKILLS_ROUTE, STEWARTOS_ROUTE } from '../../routes'
...
const SIDEBAR_NAV: SidebarNavItem[] = [
  ...
  { id: 'stewartos', label: '', icon: props => <Codicon name="dashboard" {...props} />, route: STEWARTOS_ROUTE }
]
            ...
            <SidebarMenu className="gap-px">
              {SIDEBAR_NAV.map(item => {
                ...
                const active =
                  ...
                  (item.id === 'stewartos' && currentView === 'stewartos')
